  ...
  return (
    <div className="w-[50%] mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        ...
        <button type="button" className="w-[70%] mb-2 m-auto rounded-full flex items-center justify-center gap-2 bg-white text-black py-2 border border-gray-300 hover:bg-gray-100" onClick={()=> signIn("google", { callbackUrl: "/" })}>
